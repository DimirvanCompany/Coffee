            ...
            <>
                ...
                <Row className='bg-gray-200 rounded-xl'>
                    ...
                    <Col xs = {4}>
                        ...
                        <button className="btn my-3 border-0 orange-bg" id="btn-radius" onClick={addToMenuHandler}>
                            افزودن    
                        </button>
                        </div>
                    </Col>
