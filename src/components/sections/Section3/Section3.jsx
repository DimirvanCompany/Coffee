        ...
        <Container>
          <Row className="align-items-center">
            <Col className="my-2" sm="12" md="6">
              <div
                className="rounded-5 border-start-0 border-top-0 border border-3 border-warning d-flex align-items-center"
                id="background-image"
              >
                <div
                  className="gray-bg rounded-4 border-end-0 border-top-0 border border-4 border-warning"
                  id="media-query"
                >
                  {data.map((item) => (
            ...
            <Col sm="12" md="5" className="offset-md-1 my-2">
              <h2 className="my-3 text-light">درباره کافه آراد</h2>
